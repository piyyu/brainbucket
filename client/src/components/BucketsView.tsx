...
import { FileText, ExternalLink, Trash2, Search, FolderOpen, Clock, Plus } from "lucide-react";
          ...
          {loading ? (
            ...
            <div className="space-y-2">
              {filtered.map((bucket, idx) => (
                ...
                >
                  {/* Hover gradient */}
                  <div className="absolute inset-0 rounded-xl bg-gradient-to-br from-sky-500/5 to-indigo-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none" />
                  ...
                  <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-sky-500/20 to-indigo-500/20 border border-sky-500/10 flex items-center justify-center shrink-0 relative z-10 group-hover:from-sky-500/30 group-hover:to-indigo-500/30 transition-all">
                    <FileText className="w-4 h-4 text-sky-400" strokeWidth={1.5} />
                  </div>
